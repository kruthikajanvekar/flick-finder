...
- **Collaborative Filtering** → Uses patterns from other users with similar tastes.
- **Hybrid Recommendation** → Combines both approaches for better accuracy.
...
- **Jupyter Notebook** (Exploration and model building)
